...
public class CameraSettings {
    ...
    private static final String KEY_QC_SUPPORTED_HDR_MODES = "hdr-mode-values";
    ...
    public static final String KEY_QC_HDR_MODE = "hdr-mode";
    ...
    public static List<String> getSupportedHDRModes(Parameters params) {
        String str = params.get(KEY_QC_SUPPORTED_HDR_MODES);
        if (str == null) {
            return null;
        }
        return split(str);

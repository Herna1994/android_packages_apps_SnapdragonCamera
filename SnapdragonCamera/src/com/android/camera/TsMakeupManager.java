...
public class TsMakeupManager implements OnSeekBarChangeListener {
    ...
    public static final boolean HAS_TS_MAKEUP = android.os.SystemProperties.getBoolean(
    ...
    public TsMakeupManager(CameraActivity activity, PhotoMenu menu, PhotoUI ui,
        ...
        mMakeupLayoutRoot = (RelativeLayout) mUI.getRootView().findViewById(
                R.id.id_tsmakeup_level_layout_root);
    ...
    public void showMakeupView() {
        ...
        Log.d(TAG, "TsMakeupManager.showMakeupView(): rotation is " + rotation + ", WH is ("
                + width + ", " + height + "), margin is "
    ...
    private void showSingleView(String value) {
        if (MAKEUP_NONE.equals(value)) {
            ...
            Log.d(TAG, "TsMakeupManager.showSingleView(): rotation is " + rotation + ", WH is ("
                    + width + ", " + height + "), margin is "
                    + margin + ", levelBgSize is " + levelBgSize);
            ...
            RelativeLayout.LayoutParams rootParams = new RelativeLayout.LayoutParams(size,
            ...
            layout.findViewById(R.id.id_layout_makeup_back).setOnClickListener(
                    new OnClickListener() {
                        @Override
            ...
            layout.findViewById(R.id.id_layout_makeup_whiten).setOnClickListener(
                    new OnClickListener() {
                        @Override
                        public void onClick(View v) {
            ...
            layout.findViewById(R.id.id_layout_makeup_clean).setOnClickListener(
                    new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (mMode == MODE_CLEAN) {

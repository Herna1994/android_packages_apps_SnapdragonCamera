...
public class PhotoMenu extends MenuController
    ...
    public void initialize(PreferenceGroup group) {
        ...
        if (TsMakeupManager.HAS_TS_MAKEUP) {
            ...
            if (mTsMakeupManager == null) {
                mTsMakeupManager = new TsMakeupManager(mActivity, this, mUI, mPreferenceGroup,
                        mTsMakeupSwitcher);
    ...
    public void initMakeupModeButton(View button) {
        ...
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ListPreference faceDetectPref = mPreferenceGroup.findPreference(
                        CameraSettings.KEY_FACE_DETECTION);
                ...
                if ((faceDetection != null) && Parameters.FACE_DETECTION_OFF.equals(
                        faceDetection)) {
    ...
    private void showAlertDialog(final ListPreference faceDetectPref) {
        ...
        new AlertDialog.Builder(mActivity)
            ...
            .setPositiveButton(R.string.text_tsmakeup_alert_continue,
            ...
            .setNegativeButton(R.string.text_tsmakeup_alert_quit,
                    new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                }
